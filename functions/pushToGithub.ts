...
Deno.serve(async (req) => {
  try {
    ...
    // Step 1: Strip all existing \$ (any number of backslashes before $) back to bare $
    // Step 2: Re-escape every $ that is NOT a valid Dart interpolation (not followed by { or identifier)
